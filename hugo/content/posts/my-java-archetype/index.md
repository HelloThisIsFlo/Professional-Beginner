...
I believe there is a third way, a middle ground where **current productivity encounters future maintainability**.<!--more-->
...
![The Flow of Dependency](flowoverview.jpg)
...
###### [Presentation module](#the-presentation-module)
  * [Role & Highlights](#role--highlights)
  * [Interface with the User](#interface-with-the-user)
  * [MVC, MVP, MVVM](#mvc-mvp-mvvm)

###### [Domain: Application layer](#the-domain-application-layer)
  * [Role & Highlights](#role--highlights-1)
  * [Elements](#elements)
  * [Interaction with the Presentation module](#interaction-with-the-presentation-module)
  * [Making the Domain (Quasi-)Stateless](#making-the-domain-quasi-stateless)
  * [Accessing the Data module](#accessing-the-data-module)

###### [Domain: Core](#the-domain-the-core)
  * [Role & Highlights](#role--highlights-2)
  * [Elements](#elements-1)
  * [Designing the Domain 101](#designing-the-domain-101)
  * [My Best Practices](#my-best-practices)

###### [Domain: Interface layer](#the-domain-interface-layer)
  * [Role & Highlights](#role--highlights-3)
  * [Enhancing the Core](#enhancing-the-core)
  * [Example: A weird XML parser](#example-a-weird-xml-parser)
  * [Persistance: Another contract](#persistance-another-contract)

###### [Data module](#the-data-module)
  * [Role & Highlights](#role--highlights-4)
  * [Just another Domain's need](#just-another-domains-need)
  * [ORMs and Mapping](#orms-and-mapping)
  
###### [Extra: 3rd-Party modules](#extra-3rd-party-modules-1)
  * [Role & Highlights](#role--highlights-5)
...
In my Java Archetype I do not use DTOs between modules to represent Domain Objects, as opposed to what I discussed in this article: [The DTO Dilemma](/the-dto-dilemma).
...
The Presentation module does, however, have access to Domain [Value-Objects](#elements-1), since these are merely immutable data structures. 
...
Instead, it accesses the Data module through an interface: [The Repository](#persistance-another-contract)
...
Transitions, Aggregates, Aggregate Roots? No stress, I introduce these concepts a bit later: [Designing the Domain 101](#designing-the-domain-101)
...
More on that in [The Interface layer](#the-domain-interface-layer)
...
The lifecycle of Domain Objects is managed in [The Application layer](#the-domain-application-layer).
...
Moreover, as mentioned in the part about [The Application layer](#making-the-domain-quasi-stateless), Service operations only act on **persisted** Entities. 
...
If you are interested to know more about my interest in TDD, check out this article: [TDD, my hopes](/tdd-my-hopes)
...
The repository abstracts away all persistence-related operations, and it acts on [Aggregate Root](#aggregates--aggregate-roots). 
...
This Archetype is also very similar to my series on [The Hexagonal Architecture](/hexagonal-android-pt1-intro).
